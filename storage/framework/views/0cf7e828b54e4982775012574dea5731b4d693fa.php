...
<legend><h1>Update movie here</h1></legend>
...
<?php echo Form::model($movie,array('method' => 'put','class'=>'form-horizontal','files'=>'true','action' => ['MoviesController@update',$movie->id])); ?>
